			...
			<form method="POST" id="formulario" enctype="multipart/form-data" action="">
				...
				<table class="tabla">	
					...
					<tr>
						...
						<td>
							<input type="text" name="tamaño" class="campos" required placeholder="Libras">
						</td>
						<td>
							<h3>Pisos:</h3>
						</td>
						<td>
							<input type="number" name="pisos" class="campos" required>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td colspan="6">
							<a href="prueba.php" class="boton" style="width: 300px;">   Generar Pdf </a>
