...
<html>
	...
	<header>
		...
		<form action="" method="POST" id="formulario">
			...
			<tr>
				<td>
					<input type="number" name="id" class="campos" required placeholder="ID del pedido">
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
					<select name="estado" class="campos" required>
			...
			<tr>
				<td colspan="2">
					<button type="button" id="botonmodificar" class="boton">Modificar</button>
				</td>
			</tr>
			</table>
		</form>
